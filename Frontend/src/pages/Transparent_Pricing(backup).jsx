...
[&::-webkit-scrollbar-thumb]:rounded-full"
            ...
            {selectedCourse1 &&
                ...
                <div className="fixed inset-0 z-[60] flex items-center justify-center [rgba(0,0,0,0.65)] backdrop-blur-[12.5px]">
                  <div className="w-[90%] max-w-[90.5555555556em] lg:max-w-[26.1458333333em] md:max-w-[26.1458333333em] bg-[#16181D] rounded-2xl relative flex flex-col lg:h-[36.7708333333vw] md:h-[36.7708333333vw] h-[117.5em] py-5 lg:py-[1.3227513228vw] lg:pl-[1.7195767196vw]">
                    <div className="px-4 lg:px-[0] border-white/10">
                      ...
                      <h2 className="text-[#FBFFDB] lg:text-[1.1574074074vw] md:text-[1.1458333333em] text-[4.4444444444em] leading-normal lg:leading-[1.22] lg:mb-[1.1243386243vw] font-[500] pricepop-heading lg:tracking-[0.1px] mb-[1.0582010582vw]">
              ...
              [&::-webkit-scrollbar-thumb]:rounded-full"
                    >
                      ...
                      <ul className="space-y-[0.6613756614vw] text-[#838383] lg:text-[1.1044973545vw] md:text-[1.09375em] text-[3.8888888889em] mb-4 list-disc pl-5 lg:pl-[1.5873015873vw] lg:marker:text-[15px] lg:max-w-[21.0416666667vw]">
                        {(currentCourseDetail.content || []).map((item, i) => (
                          <li
                            key={i}
                            className="leading-relaxed lg:leading-[1.30] lg:[margin-block-end: 0.6613756614vw] font-[385] pl-1"
                            dangerouslySetInnerHTML={{ __html: item }}
                          />
                        ))}
                      </ul>

                      <p className="text-white lg:text-[1.1458333333em] md:text-[1.1458333333em] text-[4.4444444444em] mb-1 lg:mb-[0.5291005291vw] lg:mt-[1.455026455vw]">
                        Validity
                      </p>
                      <ul className="list-disc pl-5 lg:pl-[1.5873015873vw] text-[#838383] lg:text-[1.09375em] md:text-[1.09375em] text-[3.8888888889em] mb-4 lg:marker:text-[15px] lg:max-w-[21.0416666667vw]">
                        <li className="pl-1">{currentCourseDetail.validity}</li>
                      </ul>
                      ...
                      <ul className="list-disc pl-5 lg:pl-[1.5873015873vw] text-[#838383] lg:text-[1.09375em] md:text-[1.09375em] text-[3.8888888889em] mb-4 lg:marker:text-[15px] lg:max-w-[21.0416666667vw]">
                        <li className="pl-1">{currentCourseDetail.whothis}</li>
                      </ul>
                      ...
                      <p className="text-white lg:text-[1.1458333333em] md:text-[1.1458333333em] text-[4.4444444444em] mb-1 lg:mb-[0.5291005291vw] lg:mt-[1.455026455vw] pl-1">
                        Number of devices?
                      </p>
                      <ul className="list-disc pl-5 lg:pl-[1.5873015873vw] text-[#838383] lg:text-[1.09375em] md:text-[1.09375em] text-[3.8888888889em] mb-4 space-y-2 lg:marker:text-[15px] lg:max-w-[21.0416666667vw]">
                      ...
                      <ul className="list-disc pl-5 lg:pl-[1.5873015873vw] text-[#838383] lg:text-[1.09375em] md:text-[1.09375em] text-[3.8888888889em] mb-4 lg:marker:text-[15px] lg:max-w-[21.0416666667vw]">
                        <li className="pl-1">{currentCourseDetail.examfee}</li>
                      </ul>
                      ...
                      />
                      <p
                        className="text-white lg:text-[1.09375em] md:text-[1.09375em] text-[3.8888888889em] mb-[0.529101vw] mt-[1.455026455vw]"
                        dangerouslySetInnerHTML={{
  ...
  ${
    status === "valid" || status === "invalid" || status === "expired"
      ? "lg:h-[36.8475em] h-[119.4444444444em]"
      : "lg:h-[35.1475em] h-[115.4444444444em]"
  }`}
              >
        ...
        : status === "expired"
          ...
          : status === "valid"
            ...
            : ""
                ...
                <div className="flex items-start lg:gap-2 gap-[3.6458333333vw] lg:text-[1.0416666667em] md:text-[1.0416666667em] text-[3.0729166667vw] text-[#98999F] relative w-[81.1111111111vw] lg:w-[30.1111111111vw] lg:mb-0 mb-[5px]">
                  <input
                    id="disclaimer-checkbox"
                    type="checkbox"
                    className="scale-115 h-[18px] w-[18px]"
                    checked={isChecked}
                    onChange={(e) => {
                ...
                <div className="lg:mt-[0.5291005291vw] mt-auto flex items-center justify-center">
                  <button
                    ...
                    className={`lg:w-[22.4479166667vw] md:w-[20.4479166667em] w-[80.2083333333vw] bg-[#4BAF4F] text-white py-[4.5572916667vw] lg:py-[1.1243386243vw] lg:text-[1.3020833333vw] md:text-[1.3020833333vw] text-[4.4444444444em] rounded-lg font-medium mt-[1.0416666667vw] lg:mb-[1.0416666667vw] mb-[3.3854166667vw] cursor-pointer
  ${
    status === "valid"
      ...
      <div className="w-full text-white py-[7.2916666667em] lg:px-6 mt-3">
        <div className=" mx-auto text-center">
          <h2 className="text-[6.1111111111em] md:text-[2.380952381vw] lg:text-[2.380952381vw] lg:font-[400] font-[500] lg:mb-[1.9841269841vw] mb-[7.8125vw] tracking-[0.2px] leading-[1.22727] lg:leading-normal">
          ...
          {/* Mobile */}
          <div className="flex md:hidden md:flex-row items-center md:items-start justify-center gap-[9.1746031746vw] mb-10 p-4">
            <div className="flex flex-col items-center md:items-start gap-[1.1458333333vw]">
            ...
            <div className="flex flex-col md:items-start items-start gap-[1.1458333333vw]">
              <p className="text-[3.8888888889em] md:text-[1.1904761905vw] lg:text-[1.1904761905vw] font-[500] -tracking-[0.44px] text-[#737886] leading-[1.28571] lg:leading-normal text-left mb-3">
                {trustedSection.avatar_text}
              </p>
          ...
          <div className="relative flex justify-center my-2 overflow-hidden">
            <div className="w-full flex items-center justify-center">
              <img
                src={Frame}
                alt=""
                className="w-[125%] md:w-full max-w-none object-contain mix-blend-screen"
              />
            </div>
          </div>
      ...
      <div className=" relative z-10 sm:mb-[0] mb-[-13.8888888889vw]">
        <div className="custom-container mx-auto md:py-[6.6137566138em] sm:py-[4.6296296296em] py-[40px] px-4 sm:px-[2.1164021164em] w-full z-10 relative pt-[20.5729166667vw] pb-[18.4895833333vw] lg:pt-0 lg:pb-0">
          ...
          <h2 className="font-inter font-[500] md:text-[3.0423280423vw] sm:text-[6.258148631em] text-[8.59375vw] leading-[1.2258] lg:mt-[0.1315789474em] xs:mt-0 mt-[3.125vw] text-[#FBFFDB] text-center sm:mb-[0.6578947368em] mb-[10.4166666667vw] md:mb-[3.3068783069vw] xs:tracking-normal tracking-[0.5px]">
