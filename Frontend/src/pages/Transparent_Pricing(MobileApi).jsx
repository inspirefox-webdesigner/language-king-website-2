...
[&::-webkit-scrollbar-thumb]:rounded-full"
                      ...
                      {(currentCourseDetail.popupDetails || []).map(
                        (section, sIndex) => (
                          <div key={sIndex} className="px-[4.6875vw] lg:px-0">
                            <p
                              className={`text-white lg:text-[1.1458333333em] md:text-[1.1458333333em] text-[4.4444444444em] mb-[1.8229166667vw] lg:mt-0 lg:mb-[0.5291005291vw] ${
                                sIndex !== 0
                                  ? "mt-[4.4270833333vw] lg:mt-5"
                                  : "mt-0 lg:mt-1"
                              }`}
                            >
      ...
      relative overflow-hidden`}
              >
                {/* ── Card light sweep ── */}
                <div
                  className={showSuccessAnim ? "card-sweep-div" : ""}
                  style={{
                    position: "absolute",
                    inset: 0,
                    background:
                      "linear-gradient(110deg, transparent 30%, rgba(74,222,128,0.06) 50%, transparent 70%)",
                ...
                <div className="relative z-[1] flex flex-col flex-1">
                  ...
                  <div className="flex gap-[2.6041666667vw] lg:gap-3 mb-[2.0833333333vw] lg:mb-[0.5291005291vw]">
                    <input
                      ...
                      onBlur={() => {
                        if (status === "typing") setStatus("idle");
                      }}
            ...
            ${
              status === "idle"
                ...
                : status === "typing"
                  ...
                  {/* Valid coupon success msg — with floating sparks */}
                  {status === "valid" && (
                    <div className="flex items-center gap-2 lg:mt-[0.1322751323vw] relative">
                      {/* ── Floating spark particles around banner ── */}
                      {showSuccessAnim && (
                        <>
                          {[
                            {
                            ...
                            <span
                              ...
                              style={{
                                ...
                                "--ty": s.ty,
                                "--rot": s.rot,
                                animation: `sparkFloat ${s.dur} ease ${s.delay} forwards`,
                              }}
                            />
                          ))}
                        </>
                  ...
                  <div className="flex justify-between text-white lg:mb-4 mb-[4.0506329114vw]">
                    ...
                    <div className="flex items-center gap-3 lg:gap-[1.3227513228vw]">
                      {/* ── 6. Old price — fade in, strikethrough stays permanently ── */}
                      {status === "valid" && (
                        <span
                          className="lg:text-[1.2566137566vw] md:text-[1.2em] text-[3.6458333333vw] text-[#98999F] font-[600] lg:tracking-[0.5px] relative"
                          style={{
                        ...
                        >
                          ...
                          {/* Strike line — draws once, stays */}
                          <span
                            className="absolute left-0 right-0 top-1/2 h-[2px] bg-[#98999F] origin-left"
                            style={{
                              transform: strikeVisible
                                ? "scaleX(1)"
                                : "scaleX(0)",
                              transition: strikeVisible
                      ...
                      {/* ── 7. New price — bounce + green flash ── */}
                      <span
                        key={priceZoom ? "zoom" : "idle"}
                        className="lg:text-[1.5625vw] md:text-[1.5625em] text-[4.7222222222em] font-semibold lg:tracking-[0.5px]"
                        style={{
                          display: "inline-block",
                          animation: priceZoom
                            ? "priceBounce 0.6s cubic-bezier(0.34, 1.56, 0.64, 1) forwards"
                            : "none",
                        }}
                      >
